...
import { Flex, Grid, SpanInfoPrimary, SpanInfoSecondary } from "../../../Utils/Utility.style"
    ...
    <Flex alignItems="center" flexDirection={["column", "row"]}>
      ...
      <Flex width={["100%", "60%"]} justifyContent="flex-end">
        <Grid gridTemplateColumns="auto auto">
          ...
          <CardBox height={128} width={[210, 242]} backgroundImage="url('images/Rectangle.png')" backgroundSize="cover">
